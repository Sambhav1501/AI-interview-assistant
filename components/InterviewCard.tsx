    ...
    return (
        <div className="card-border w-[360px] max-sm:w-ful min-h-96">
            <div className="card-interview">
                <div>
                    <div className="absolute top-0 right-0 w-fit px-4 py-2 rounded-bl-lg bd-light-600">
                    ...
                    <p className="line-clamp-2 mt-5">
                        {feedback?.finalAssessment || "You have not taken the interview. Take it now and improve your skills."}
                    </p>
